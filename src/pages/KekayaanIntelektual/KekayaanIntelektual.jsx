        ...
        <div style={styles.card}>
          ...
          >
            <h3 style={{ fontSize: "15px", margin: 0 }}>
              Daftar Portofolio Kekayaan Intelektual
            </h3>
          ...
          <div style={styles.emptyState}>
            <p style={{ color: "#94a3b8" }}>
              Belum ada data kekayaan intelektual.
            </p>
          </div>
        </div>
      )}
        ...
        <div style={styles.card}>
          ...
          >
            <h3 style={{ fontSize: "16px", margin: 0 }}>
              Tambah Data Kekayaan Intelektual
            </h3>
            <button onClick={() => setView("list")} style={styles.btnClose}>
              ✖
            </button>
          </div>
          ...
          >
            <InventorSection
              title="Inventor / Pencipta Dosen"
              nameLabel="Nama Dosen"
            />
            <InventorSection
              title="Inventor / Pencipta Mahasiswa"
              nameLabel="Nama Mahasiswa"
            />
            <InventorSection
              title="Inventor / Pencipta Luar Kampus"
              nameLabel="Nama"
            />
            <button
              style={styles.btnSimpanFull}
              onClick={() => {
                alert("Disimpan!");
                setView("list");
              }}
...
function FileUploadRow({ label }) {
  ...
  return (
    <div style={styles.rowFlex}>
      ...
      />
      <button style={styles.btnCari} onClick={() => ref.current.click()}>
        Cari
      </button>
    </div>
  );
  ...
  return (
    <div style={{ marginBottom: "30px" }}>
      ...
      <div style={{ display: "flex", gap: "10px", marginBottom: "5px" }}>
        <span style={{ flex: 2, fontSize: "11px", fontWeight: "bold" }}>
          {nameLabel}
        </span>
        <span style={{ width: "80px", fontSize: "11px", fontWeight: "bold" }}>
          Urutan
        </span>
        <span style={{ flex: 1, fontSize: "11px", fontWeight: "bold" }}>
          Peran
        </span>
      </div>
      {members.map((m) => (
